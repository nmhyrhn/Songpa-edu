...
def build_graph():
  ...
  builder.add_node("retireve", retrieve)
  builder.add_node("generate", generate)
  builder.edge(START, "retireve")
  builder.edge("retireve", "generate")
  builder.edge("generate", END)
...
def main() -> None:
  ...
  for label, question in DEMO_QEUSTIONS:
    result = graph.invoke(
